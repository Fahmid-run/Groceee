...
function Hero() {
  return (
    <div className="min-h-screen  px-40 flex items-center justify-center  bg-linear-to-r to-primary-500 from-primary-800 text-surface">
      <div className="flex justify-between items-center flex-col md:flex-row w-full">
        <div className="left w-full md:w-3/2 *:my-3">
          ...
          <h1 className="font-bold text-4xl">From Fields To Your Kitchen</h1>
